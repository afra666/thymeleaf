...
public class App {
    ...
    public String toString(HttpServletRequest request) throws IOException {
        ...
        //windows
        File file=new File("D:/webtest/"+username+".c");
        //ubuntu
       //File file=new File("/home/ad/webtest/"+username+".c");
        if (!file.exists()){
            file.createNewFile();
...
/**a.html
 ...
 <textarea name="code01" id="" cols="30" rows="10" placeholder="请输入C语言代码"></textarea><br>
 <input type="submit">
 </form>
 </body>
 </html>
